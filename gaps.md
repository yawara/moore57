...
character/final-character packages, the complementary route now goes straight
to fixed-star, `K_{1,55}`, fixed-center leaf, representation-component,
...
supplied as a separate representation decomposition hypothesis.
